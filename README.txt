# This script scrapes the most recent 90-day-median prices for a list of items from https://warframe.market 
# using the warframe.market API.
...
#    2a. If you do not get something like this 
